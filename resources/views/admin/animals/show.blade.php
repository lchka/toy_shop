            ...
            <div class=" shadow-xl sm:rounded-lg">
                <div class="my-6 p-6 border-b border-gray-200 shadow-xl sm:rounded-lg">
                    ...
                    <div class="bg-white border-b border-gray-200 shadow-xl sm:rounded-lg p-6 mb-6">
                        ...
                        <p class="text-gray-700"><span class="font-bold">Animal Name:</span> {{ $animal->animal_name }}
                        </p>
                        ...
                        <p class="text-gray-700"><span class="font-bold">Country of Origin:</span> {{ $animal->country
                            }} </p>
                        <x-primary-button><a
                                href="{{ route('admin.animals.edit', $animal) }}">Edit</a></x-primary-button>
                    ...
                    @forelse ($toys as $toy)
                    <x-card>
                        <a href="{{ route('admin.toys.show', $toy->id) }}" class="font-bold text-2xl"> {{ $toy->name }}
                        </a>
